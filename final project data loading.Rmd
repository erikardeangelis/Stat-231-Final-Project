...
current_bind <- rbind('data/florida_violation_01_10', 'data/florida_violation_01_11')

all_florida_restaurants <- for(month in c('01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12')){
  for(year in 10:15){
  if((month != '01' & year != '10') & (month != '01' & year != '11'))
   current_bind <- rbind(current_bind, sprintf('data/florida_violation_%s_%s', month, year))
  }
}
```
